    ...
    public MyFrame() {
      ...
      //Création du champ de texte pour le flux du parking 2
        ...
        try {
        	...
        	JOptionPane.showMessageDialog(displayGraph, "L'image n'a pas pu être affichée. Assurez-vous d'avoir l'image Graph à l'intérieur du même package que cette classe");
        }
